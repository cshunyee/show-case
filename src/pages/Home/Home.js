        ...
        <>
            ...
            <Anchor className="menu-achor">
                ...
                <AnchorLink href="#projectList" title="Project List">
                    <AnchorLink href="#123rf" title="123RF" />
                ...
                >
                    <div style={{ textAlign: "center" }}>
                        ...
                        >
                            ...
                            advanced web development with three years
                            experiences. Knowledgeable in user interface,
                            testing, and debugging processes. Bringing forth
                            expertise in design, installation, testing and
                            maintenance of web systems. Proficient in an
                            assortment of technologies, including
                            <b> React, NextJS, Python, Django, MySQL</b>. Able
                            to effectively self-manage during independent
                            projects, as well as collaborate in a team setting.
                            A fast learner with a great work ethic and the
